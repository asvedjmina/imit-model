...
#jl savefig(plt_r1, plotsdir(script_name, "sir_sweep_infected.png"))
...
#jl savefig(plt_r2, plotsdir(script_name, "sir_sweep_Re.png"))
...
#jl savefig(plt_r3, plotsdir(script_name, "sir_sweep_outcomes.png"))
...
#jl savefig(plt_r4, plotsdir(script_name, "sir_sweep_panel.png"))

# ## Бенчмарк производительности
#
# Оцениваем время одного численного решения задачи.

#nb @benchmark solve(prob_ode, dt = δt)
#jl @benchmark solve(prob_ode, dt = δt)
